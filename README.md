# 🔥🔥 FACECLUB Social Media App

FaceClub is a fully functional social media app with multiple features built with flutter and dart.
...
* Custom photo feed
* Post photo and Video posts from camera or gallery
    * Like posts
    * Comment on posts
...
* Full Chat Feature with Image, Post, Videos Sharing Feature

## Screenshots
* I don't have screenshots as I left this project 3 Years Ago, but if you Manage to run is successfully Make a pull request and Add screenshots.
...
* Enable Network Permission in AndroidManifest.xml
* Add Firebase Messanging Dependencies in AndroidManifest.xml
