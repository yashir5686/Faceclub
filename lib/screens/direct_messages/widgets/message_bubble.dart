...
// import 'package:instagrampub/screens/direct_messages/nested_screens/full_screen_image.dart';
// import 'package:instagrampub/services/api/chat_service.dart';
...
//                                 Navigator.pop(context, 'message deleted');
//                               },
//                               child: Text('Yes')),
//                         ],
//                       )
//                     : AlertDialog(
//                       title: Text('This is sent by ${widget.chat.memberInfo[receiverIndex].name} at ${timeFormat.format(widget.message.timestamp.toDate())}'),
//                     );
//               });
//         },
//         child: Row(
