...
final darkTheme = ThemeData(
  ...
  appBarTheme: AppBarTheme(color: Colors.black),//const Color(0xFF212121)),
  ...
  cardColor: Colors.grey[800], textSelectionTheme: TextSelectionThemeData(selectionColor: Colors.white54),
);
...
final lightTheme = ThemeData(
  ...
  cardColor: Colors.grey[300], textSelectionTheme: TextSelectionThemeData(selectionColor: Colors.black38),
);
